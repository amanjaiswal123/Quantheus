...
def Backtest(func,WData=['all'],End_Date=_datadate(), Start_Date=None, Days=None,StartingOffset=0,EndOffset=0,SC = 6000,IntialMarginRequirment=1.5,MaintenceMarginRequirment=1.3,marg_call_protect=True,BacktestTitle='Backtest'):
